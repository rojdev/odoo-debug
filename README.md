...
* **Smart Redirection:** Correctly places debug parameters before the URL hash (`#`).
* **Multi-Domain Support:** Save and manage different configurations for Local, Staging, and Production.
* **Quick Activation:** 1 click for standard debug, double click for assets mode.
* **Dynamic Icon:** Visual feedback through colors (Green: Debug, Blue: Assets, Red: Paused, Grey: Inactive).
* **Auto-Add:** Option to automatically save new Odoo domains while browsing.
* **Dark Mode:** UI automatically inherits your system/browser theme.

---

> **Note:** As mentioned in the documentation, the settings view is not real-time; if you use the "Auto-add" feature, remember to refresh the popup to see the newly added domains in the list.
